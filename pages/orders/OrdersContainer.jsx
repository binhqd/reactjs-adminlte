...
class OrdersContainer extends React.Component {
  ...
  cancel(id, reload) {
    if ("Bạn có muốn hủy đơn hàng này không?") {
      Orders.actions.update.request({id}, {
        data: {
          status: 2
        }
      }).then(response => {
              ...
              return (
                <div>
                  <div className='row'>
                    ...
                    <button className="btn btn-danger" type="button" onClick={this.cancel.bind(this, item.id, reload)}>Hủy đơn</button>&nbsp;
